...
# Paths
face_extraction_output_path = os.path.join(output_root_folder_path , '/face_extractions/')
face_extraction_output_bad_path = os.path.join(output_root_folder_path , '/face_extractions/rejected/')
