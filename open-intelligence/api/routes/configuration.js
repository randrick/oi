    ...
    const response = {
      ...
      fields: {
        app: {
          ...
          output_folder: utils.ConfigValue(configurations, 'output_folder', '/output/'),
        },
        yolo: {
        ...
        camera: {
          ...
          camera_names: utils.ConfigValue(configurations, 'camera_names', 'HikVision'),
          camera_folders: utils.ConfigValue(configurations, 'camera_folders', '/HikVision/,'),
        },
        openalpr: {
          enabled: utils.ConfigValue(configurations, 'enabled', 'True'),
          region: utils.ConfigValue(configurations, 'region', 'us'),
          use_plate_char_length: utils.ConfigValue(configurations, 'use_plate_char_length', 'True'),
          plate_char_length: utils.ConfigValue(configurations, 'plate_char_length', '7'),
        },
        facerecognition: {
